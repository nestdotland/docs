...
```shell script
deno run -A --unstable https://x.nest.land/eggs@0.2.2/mod.ts install -A -f --unstable -n eggs https://x.nest.land/eggs@0.2.2/mod.ts
```
or
```shell script
eggs install -A -f --unstable -n eggs https://x.nest.land/eggs@0.2.2/mod.ts
```
